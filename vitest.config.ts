...
export default defineConfig({
  test: {
    ...
    env: {
      ...
      PIPEDRIVE_OAUTH_CLIENT_ID: 'test-pipedrive-client-id',
      PIPEDRIVE_OAUTH_CLIENT_SECRET: 'test-pipedrive-client-secret',
      REPORTS_SMTP_HOST: 'smtp.test.local',
      REPORTS_SMTP_PORT: '587',
      REPORTS_SMTP_SECURE: 'false',
      REPORTS_SMTP_USERNAME: 'test-reports-smtp-username',
      REPORTS_SMTP_PASSWORD: 'test-reports-smtp-password',
